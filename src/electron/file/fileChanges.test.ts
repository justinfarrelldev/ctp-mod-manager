...
describe('removeLinesFromFile', () => {
    it('should remove lines at the specified line numbers', () => {
        ...
        const { lines: newLines } = removeLinesFromFile({
            fileName,
            installDir,
            lineChangeGroup,
            lineMap,
        ...
        expect(newLines).toStrictEqual(['line 1', 'line 4']);
        expect(fs.writeFileSync).toHaveBeenCalledWith(
            `${installDir}\\${fileName}`,
            newLines.join('\n'),
            'utf-8'
    ...
    it('should update the lineMap correctly after removing lines', () => {
        ...
        const { lineMap: newLineMap } = removeLinesFromFile({
            fileName,
            installDir,
            lineChangeGroup,
            lineMap,
    ...
    it('should correctly apply multiple remove changes and update the lineMap', () => {
        ...
        const { lineMap: newLineMap, lines: newLines } = removeLinesFromFile({
            fileName,
            installDir,
            lineChangeGroup: lineChangeGroup1,
            lineMap,
        ...
        const { lineMap: newLineMap2, lines: newLines2 } = removeLinesFromFile({
            fileName,
            installDir,
            lineChangeGroup: lineChangeGroup2,
            lineMap: newLineMap,
        ...
        expect(newLines2).toStrictEqual(['line 2', 'line 5']);
        expect(newLineMap2).toStrictEqual(
            new Map<number, number>([
                [1, 0],
                [4, 1],
